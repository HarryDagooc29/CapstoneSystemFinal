...
namespace HarryMidterm.Controllers
{
    public class BorrowerController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NewBorrowerId,LastName,FirstName,MiddleName,BirthDate,BirthPlace,Sex,City,Province,ZipCode,Nationality,MaritalStatus,Occupation,Salary,CoMaker,LoanType,DaysToPay,PartialPayment,Collectible,Capital,Username,Password")] Newborrower newborrower)
        {
        ...
        public async Task<IActionResult> Edit(int id, [Bind("NewBorrowerId,LastName,FirstName,MiddleName,BirthDate,BirthPlace,Sex,City,Province,ZipCode,Nationality,MaritalStatus,Occupation,Salary,CoMaker,LoanType,DaysToPay,PartialPayment,Collectible,Capital,Username,Password")] Newborrower newborrower)
        {
